      ...
      <div class="col-12 col-xl-6 text-hero">
        <div class="text">
          ...
          <p data-aos="fade-up" class="desc">
            {{ __('The company offers a wide range of original and certified car spare parts for all types of vehicles, with exceptional customer service to ensure your comfort and trust.') }}
          </p>
